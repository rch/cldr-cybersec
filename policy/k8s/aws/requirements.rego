...
deny contains msg if {
    ...
    msg := "SSH key not found at ~/.ssh/cybersec.pem. Run: devenv tasks run aws:keypair:ensure"
}
...
info contains msg if {
    ...
    msg := "SSH key found at ~/.ssh/cybersec.pem (auto-imported to AWS as cybersec-<prefix>)"
}

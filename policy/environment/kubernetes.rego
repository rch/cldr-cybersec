...
#
# Config structure:
#   input.kubernetes - Kubernetes configuration from environment.json
#
# The kubernetes config is generated by _detect_kubernetes_target() in runtime.py

package environment.kubernetes

import rego.v1

# Use kubernetes config from environment.json
